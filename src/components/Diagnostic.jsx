...
const QS = [
  ...
  {id:"mal_type",section:"Practice Risk",
   ...
   options:[
     ...
     {label:"I practice in a concierge or direct care model — different coverage arrangement",value:"na_concierge",flags:[]},
  ...
  {id:"carrier_rating",section:"Practice Risk",
   ...
   showIf:a=>(a.profession==="physician"||a.profession==="surgeon")&&a.mal_type!=="none"&&a.mal_type!=="na_concierge",
   options:[
     ...
     {label:"Not applicable — I do not carry traditional malpractice insurance",value:"na",flags:[]},
   ]},
  {id:"payer_conc",section:"Practice Risk",
   ...
   options:[
     ...
     {label:"Not applicable — my practice does not bill insurance (concierge or cash-only)",value:"na",flags:[]},
   ]},
  {id:"billing_review",section:"Practice Risk",
   ...
   options:[
     ...
     {label:"Not applicable — my practice does not bill insurance",value:"na",flags:[]},
   ]},
  {id:"payroll_tax",section:"Practice Risk",
   ...
   options:[
     ...
     {label:"Not applicable — I have no employees and no payroll",value:"na",flags:[]},
   ]},
